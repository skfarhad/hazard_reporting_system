...
const IncidentDetailsPage   = () => {
  ...
  return (
    <div className='mx-auto px-8'>
      <div>
      <h1 className="py-8 text-3xl font-bold text-gray-600 mb-6 text-center">Incident ID: {incidentId}</h1>
      </div>
    <div className="md:flex items-start justify-center">
      <div className="xl:w-2/6 lg:w-2/6 w-80 md:block hidden">
        <Image loading='eager' quality="100" height={400} width={266} className="w-full" alt="image of a incident" src="https://images.unsplash.com/photo-1661868678832-f07708ee65dc?q=80&w=3570&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
      </div>
      ...
      <div className="md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
        <div>
          ...
          <p className="text-base leading-4 mt-4 text-gray-600 dark:text-gray-600">lat: 23.3122</p>
          <p className="text-base leading-4 mt-4 text-gray-600 dark:text-gray-600">lang: 90.123</p>
